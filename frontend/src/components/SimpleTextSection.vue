...
@media (prefers-color-scheme: dark) {
  ...
  .grammar-quill :deep(.ql-snow .ql-picker-label:hover),
  .grammar-quill :deep(.ql-snow .ql-picker-label.ql-active) {
    color: rgb(244 244 245);
  }
  ...
  .grammar-quill :deep(.ql-snow .ql-picker.ql-expanded .ql-picker-label) {
    border-color: rgb(82 82 91);
  }

  .grammar-quill :deep(.ql-snow .ql-picker-options) {
    border-color: rgb(63 63 70);
    background-color: rgb(24 24 27);
  }

  .grammar-quill :deep(.ql-snow .ql-picker-item) {
    color: rgb(228 228 231);
  }

  .grammar-quill :deep(.ql-snow .ql-picker-item:hover),
  .grammar-quill :deep(.ql-snow .ql-picker-item.ql-selected) {
    color: rgb(250 250 250);
    background-color: rgb(39 39 42);
  }

  .grammar-quill :deep(.ql-snow.ql-toolbar button:hover),
  .grammar-quill :deep(.ql-snow .ql-toolbar button:hover) {
    color: rgb(250 250 250);
  }

  .grammar-quill :deep(.ql-snow.ql-toolbar button:hover .ql-stroke),
  .grammar-quill :deep(.ql-snow .ql-toolbar button:hover .ql-stroke) {
    stroke: rgb(250 250 250);
  }

  .grammar-quill :deep(.ql-snow.ql-toolbar button:hover .ql-fill),
  .grammar-quill :deep(.ql-snow .ql-toolbar button:hover .ql-fill) {
    fill: rgb(250 250 250);
  }

  .grammar-quill :deep(.ql-snow.ql-toolbar button.ql-active),
  .grammar-quill :deep(.ql-snow .ql-toolbar button.ql-active) {
    color: rgb(199 210 254);
  }

  .grammar-quill :deep(.ql-snow.ql-toolbar button.ql-active .ql-stroke),
  .grammar-quill :deep(.ql-snow .ql-toolbar button.ql-active .ql-stroke) {
    stroke: rgb(165 180 252);
  }

  .grammar-quill :deep(.ql-snow.ql-toolbar button.ql-active .ql-fill),
  .grammar-quill :deep(.ql-snow .ql-toolbar button.ql-active .ql-fill) {
    fill: rgb(165 180 252);
  }

  .grammar-quill :deep(.ql-snow a) {
    color: rgb(165 180 252);
  }

  .grammar-quill :deep(.ql-tooltip) {
    border-color: rgb(63 63 70);
    background-color: rgb(24 24 27);
    color: rgb(228 228 231);
    box-shadow:
  ...
  .grammar-quill :deep(.ql-tooltip input[type="text"]) {
    border-color: rgb(63 63 70);
    background-color: rgb(9 9 11);
    color: rgb(244 244 245);
  }

  .grammar-quill :deep(.ql-tooltip a.ql-action),
  .grammar-quill :deep(.ql-tooltip a.ql-remove) {
    color: rgb(165 180 252);
  }

  .grammar-quill :deep(.ql-editor blockquote) {
    border-left-color: rgb(82 82 91);
    color: rgb(212 212 216);
  }

  .grammar-quill :deep(.ql-editor pre.ql-syntax) {
    background-color: rgb(24 24 27);
    color: rgb(228 228 231);
